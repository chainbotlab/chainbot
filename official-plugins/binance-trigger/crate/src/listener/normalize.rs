...
pub fn listener_kind(source: &str) -> &'static str {
    match source {
        "binance_market_stream" => "market_stream",
        "binance_user_stream" => "user_stream",
        _ => "event_stream",
    }
}
...
pub fn event_stream_name(
    ...
    if command.source == "binance_user_stream" {
        return String::from("user_data");
    }
...
pub fn listen_key_expired(error: &str) -> bool {
    error.contains("-1125")
}
