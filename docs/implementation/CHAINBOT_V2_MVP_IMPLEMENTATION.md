...
- Durable bootstrap record: `docs/implementation/WORKSPACE_BOOTSTRAP_IMPLEMENTATION.md`
...
- Keep durable implementation history in `docs/implementation/` and `.sisyphus/notepads/` instead of evidence logs.
