...
updated: 2026-06-10
replacement:
  - ../../../.agents/skills/decision-chainbot-cli-contract/SKILL.md
---

# ChainBot CLI Design

Archive Note: Active decision authority moved to `.agents/skills/decision-chainbot-cli-contract/SKILL.md` on 2026-06-10. This file is retained as a historical snapshot.
...
CLI 假设 ChainBot root 继续遵守 `docs/decisions/CHAINBOT_TRIGGER_WORKFLOW_CONFIG_DESIGN.md` 中定义的加载顺序与目录结构：
