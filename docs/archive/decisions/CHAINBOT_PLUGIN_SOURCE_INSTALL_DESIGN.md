...
Archive Note: Active decision authority moved to `.agents/skills/decision-chainbot-plugin-source-install/SKILL.md` on 2026-06-10. This file is retained as a historical snapshot.
