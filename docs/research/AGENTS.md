...
## Scope
- Position: Exploratory notes bucket.
- Owns: Problem framing, option comparison, risk analysis, and interim conclusions.
- Excludes: Final stable decisions and concrete implementation history.
