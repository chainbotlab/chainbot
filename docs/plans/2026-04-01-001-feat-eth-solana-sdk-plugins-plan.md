...
- `docs/plans/2026-03-31-001-feat-eth-solana-official-plugins-plan.md` 已经定义了上一阶段的 host/runtime/source/install 边界，本计划是在该基础上的 follow-up，而不是重写需求。
...
- official plugin 的 chain-specific logic 必须留在 package-local code；`chainbot runtime` 只保留 generic control-plane concerns。参考 `docs/design/CHAINBOT_OFFICIAL_PLUGIN_DESIGN.md`。
- package identity 是 directory name + package-local `config.toml` 的硬边界；rename 不是 cosmetic change。参考 `docs/design/CHAINBOT_PLUGIN_SOURCE_INSTALL_DESIGN.md` 与 `docs/design/CHAINBOT_CONFIG_STATE_LAYOUT_DESIGN.md`。
- activation secret 是 root-owned、execution-time-only、fail-closed 的 contract；不得混入 node `input` 或 trigger `params`。参考 `docs/design/CHAINBOT_PLUGIN_ACTIVATION_CONFIG_DESIGN.md`。
- trigger 扩展必须继续依赖稳定 top-level fields + `params`，而不是新增一批 root-global chain config。参考 `docs/design/CHAINBOT_TRIGGER_WORKFLOW_CONFIG_DESIGN.md`。
...
- `docs/design/CHAINBOT_PLUGIN_SOURCE_INSTALL_DESIGN.md`
...
- `docs/design/CHAINBOT_OFFICIAL_PLUGIN_DESIGN.md`
- `docs/design/CHAINBOT_PLUGIN_ACTIVATION_CONFIG_DESIGN.md`
...
- `crates/chainbot/src/app/runtime/external_triggers/process_listener.rs`
- `docs/design/CHAINBOT_OFFICIAL_PLUGIN_DESIGN.md`
- `docs/implementation/CHAINBOT_INGRESS_TRIGGER_IMPLEMENTATION.md`
...
- `crates/chainbot/src/app/runtime/external_triggers/process_listener.rs`
- `docs/design/CHAINBOT_TRIGGER_WORKFLOW_CONFIG_DESIGN.md`
...
- Modify: `docs/design/CHAINBOT_OFFICIAL_PLUGIN_DESIGN.md`
- Modify: `docs/design/CHAINBOT_PLUGIN_ACTIVATION_CONFIG_DESIGN.md`
- Modify: `docs/design/CHAINBOT_PLUGIN_SOURCE_INSTALL_DESIGN.md`
- Create: `docs/implementation/CHAIN_PLUGIN_PROVIDER_QUALIFICATION_IMPLEMENTATION.md`
...
- Prior plan: `docs/plans/2026-03-31-001-feat-eth-solana-official-plugins-plan.md`
...
- Related docs: `docs/design/CHAINBOT_PLUGIN_SOURCE_INSTALL_DESIGN.md`
- Related docs: `docs/design/CHAINBOT_TRIGGER_WORKFLOW_CONFIG_DESIGN.md`
