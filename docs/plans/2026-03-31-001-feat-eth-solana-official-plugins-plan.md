...
- `docs/design/CHAINBOT_OFFICIAL_PLUGIN_DESIGN.md` defines the official package implementation preference and thin runtime boundary.
- `docs/design/CHAINBOT_PLUGIN_ACTIVATION_CONFIG_DESIGN.md` defines operator-owned plugin activation secret bindings and execution-time injection semantics.
...
- Related docs: `docs/implementation/CHAINBOT_INGRESS_TRIGGER_IMPLEMENTATION.md`
