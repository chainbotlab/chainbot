//! [INPUT]
//! Builtin trigger handler trait objects, trigger definitions, emissions, and contract error semantics.
//!
//! [OUTPUT]
//! Provides a registry type that stores builtin trigger emitters and dispatches emission requests by source kind.
//!
//! [ROLE]
//! Encapsulates handler registration and lookup for builtin trigger fan-out.
...
use super::context::BuiltinTriggerContext;
use super::contract::BuiltinTriggerHandler;
